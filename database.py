...
def inserer_nouvel_utilisateur(user, hashed_password: str) -> int:
    ...
    try:
        ...
        for mois, valeur, annee in historique_donnees:
            cursor.execute("INSERT INTO consommations_historique (id_compteur, label_mois, valeur_kwh, annee) VALUES (?, ?, ?, ?)", (id_compteur, mois, valeur, annee))
        ...
        """, (id_compteur, ref_facture, "Mai 2026", 187, 48200.00))
